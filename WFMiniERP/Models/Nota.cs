    ...
    internal class Nota
    {
        ...
        public bool Cadastrar()
        {
            ...
            SqlCommand command = new()
            {
                ...
                CommandText = "insert into nota values (@data_compra, @fk_cliente);"
            };

            command.Parameters.Add("@data_compra", SqlDbType.DateTime);
            ...
            try
            {
                ...
                foreach(ItemNota itensNota in ItensNota)
                {
                    itensNota.Cadastrar(cn, tran);
                }
